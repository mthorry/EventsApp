...
User.create(first_name: "Matt", last_name: "Thorry", username: "mthorry", password_digest: "123", location_id: 1, bio:"Hi, I'm Matt")
User.create(first_name: "Hui", last_name: "Wang", username: "hui", password_digest: "123", location_id: 1, bio: "A former stripper")
User.create(first_name: "Some", last_name: "Guy", username: "someguy", password_digest: "123", location_id: 2, bio: "I'm just some guy")
User.create(first_name: "Sum Ting", last_name: "Wong", username: "somethingwrong", password_digest: "123", location_id: 3, bio: "Something is wrong")
